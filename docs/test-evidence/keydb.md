...
| `dbtool_it_kv_strict_keydb_*` | 25 scan keys, binary-key fixture and two-entry binary Stream PASS | full 25-key multi-page SCAN and recursive XRANGE bytes exact PASS | N/A | unknown plus KEYS/SCAN/HGETALL RAW rejected; non-UTF8 key returned serialization error PASS | limit 24 returned 24 + truncated; XRANGE over global limit rejected PASS | DEL reported 26/26 PASS | prefix SCAN empty PASS |
