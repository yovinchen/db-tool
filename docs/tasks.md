...
| T42 Real backend completeness campaign | P1 | In progress | Run every locally available registered backend against its family checklist, commit one evidence record per product, and keep external/runtime/architecture blocks explicit. | `docs/db-completeness-tasks.md`; one backend per Lore commit. |
