...
| T12 TUI workflow depth | P2 | Pending | Richer per-capability forms remain after command history and full-screen status polish were added while reusing core confirmation and limit behavior. | TUI smoke tests for forms, write confirmation, and error rendering. |
