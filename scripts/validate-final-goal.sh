...
require_file "docs/test-evidence/dependency-security-audit.md"
require_file "docs/test-evidence/sqlserver.md"
require_file "docs/test-evidence/npm-publication.md"
require_file "docs/test-evidence/db2-host-runtime-blocker.md"
require_file "docs/npm-publication-tasks.zh-CN.md"
require_file "docs/test-evidence/transfer-artifact-atomic-publication.md"
require_file "SKILL.md"
require_file ".github/workflows/release.yml"
require_file "dist/npm/package.json"
require_file "dist/npm/bin/dbtool.js"
require_file "LICENSE-MIT"
require_file "LICENSE-APACHE-2.0"
...
require_file "scripts/smoke-windows-portable.ps1"
require_executable "scripts/validate-tidb-ha-drills.sh"
require_executable "scripts/validate-container-image-pins.sh"
require_executable "scripts/validate-container-image-pins-test.sh"
...
require_executable "scripts/integration-external-requirement-test.sh"
...
require_pattern ".github/workflows/ci.yml" "windows-portable:"
require_pattern ".github/workflows/ci.yml" "smoke-windows-portable.ps1"
...
require_pattern "scripts/integration-db-suite.sh" "db2)"
require_pattern "scripts/integration-db-suite.sh" "messaging)"
require_pattern "scripts/integration-db-suite.sh" "messaging-native)"
require_pattern "scripts/integration-db-suite.sh" "messaging-tls)"
require_pattern ".github/workflows/ci.yml" "run_live_redshift"
require_pattern ".github/workflows/ci.yml" "DBTOOL_IT_REQUIRE_EXTERNAL"
require_pattern "scripts/verify.sh" "integration-external-requirement-test.sh"
...
if grep -Ev '^\| IF-T43–IF-T81 Interface completion campaign ' "$ROOT/docs/tasks.md" \
...
require_pattern "docs/tasks.md" "T45 Completeness ledger structural proof"
require_pattern "docs/tasks.md" "T46 Machine-readable CLI argument failures"
require_pattern "docs/tasks.md" "T47 Reproducible isolated product gates"
require_pattern "docs/tasks.md" "T48 Transitive dependency advisory remediation"
require_pattern "docs/tasks.md" "T49 Content-addressed container defaults"
require_pattern "docs/tasks.md" "T50 Patch release identity"
require_pattern "docs/tasks.md" "T51 npm package publication hardening"
require_pattern "docs/tasks.md" "T52 Public npm registry publication"
require_pattern "docs/test-evidence/npm-publication.md" "Result: PACKAGING_PASS_PUBLICATION_EXTERNAL"
require_pattern "docs/test-evidence/db2-host-runtime-blocker.md" "Result: BLOCKED_SUPPORTED_HOST_CLIENT_REQUIRED"
require_pattern ".github/workflows/ci.yml" "db2-client"
require_pattern ".github/workflows/ci.yml" 'odbcinst -q -d -n "IBM DB2 ODBC DRIVER"'
require_pattern "docs/test-evidence/transfer-artifact-atomic-publication.md" "Result: PASS"
require_no_pattern "docs/test-evidence/transfer-artifact-atomic-publication.md" "PENDING"
...
"$ROOT/scripts/validate-db-completeness.sh"

echo "baseline goal validation passed"
echo "interface completion campaign: 38 complete; IF-T52 external (docs/interface-completion-tasks.zh-CN.md)"
